local configuration = { -- Rename this file to configuration.lua for the bot to work!
    ['bot_token'] = os.getenv('TG_TOKEN_ONETEAM'), -- In order for the bot to actually work, you MUST insert the Telegram
    -- bot API token you received from @BotFather.
    ['connected_message'] = 'OneTeam Bot Connected to the system', -- The message to print when the bot is connected to the Telegram bot API
    ['version'] = '21.1.10', -- the version of OneTeamBot, don't change this!
    ...
    ['bug_reports_chat'] = os.getenv('LOG_ADMIN'), -- This needs to be the numerical identifier of the chat you wish to send
    ...
    ['keys'] = { -- API keys needed for the full functionality of several plugins.
        ...
        ['spotify'] = { -- https://developer.spotify.com/my-applications/#!/applications/create
            ['client_id'] = '',
            ['client_secret'] = '',
            ['redirect_uri'] = 'https://t.me/OneTeamBot?start='
        },
    ...
    ['administration'] = { -- Values used in administrative plugins
        ...
        ['global_antispam'] = { -- normal antispam is processed in plugins/antispam.oneteam
    ...
    ['stickers'] = { -- Values used in oneteam.lua, for administrative plugin functionality.
